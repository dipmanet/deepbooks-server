...
export const getBooksByListType = (listType_1, ...args_1) => __awaiter(void 0, [listType_1, ...args_1], void 0, function* (listType, pageNo = 1) {
...
export const getBooksBySearch = (searchKey_1, ...args_1) => __awaiter(void 0, [searchKey_1, ...args_1], void 0, function* (searchKey, pageNo = 1) {
    const browser = yield puppeteer.launch();
    const page = yield browser.newPage();
    yield page.goto(`https://novelfull.net/search?keyword=${searchKey}&page=${pageNo}`, {
        waitUntil: "domcontentloaded",
    });
    const resultsSelector = ".col-truyen-main > .list-truyen > .row";
    const paginationSelector = "div.pagination-container > div > ul > li.last > a";
...
export const getBookGenres = () => __awaiter(void 0, void 0, void 0, function* () {
    const browser = yield puppeteer.launch();
    const page = yield browser.newPage();
    yield page.goto(`https://novelfull.net/`, {
        waitUntil: "domcontentloaded",
    });
    const resultsSelector = "#nav > div > div > ul > li.dropdown > div > div > div > ul > li > a";
    const genres = yield page.evaluate((resultsSelector) => {
        const anchors = Array.from(document.querySelectorAll(resultsSelector));
        const novels = anchors.map((anchor, idx) => {
            var _a;
            const id = idx + 1;
            const title = anchor === null || anchor === void 0 ? void 0 : anchor.getAttribute("title");
            const link = (_a = anchor === null || anchor === void 0 ? void 0 : anchor.getAttribute("href")) === null || _a === void 0 ? void 0 : _a.split("/")[-1];
            return {
                id,
                title,
                link,
...
export const getBooksByGenre = (genre_1, ...args_1) => __awaiter(void 0, [genre_1, ...args_1], void 0, function* (genre, pageNo = 1) {
    const browser = yield puppeteer.launch();
    const page = yield browser.newPage();
    yield page.goto(`https://novelfull.net/genre/${genre}?page=${pageNo}`, {
        waitUntil: "domcontentloaded",
    });
    const resultsSelector = ".col-truyen-main > .list-truyen > .row";
    const paginationSelector = "div.pagination-container > div > ul > li.last > a";
